...
String url="";
    ListView joblist;
    EditText skills; 
	Button search,button1,button2,button3,button4,button5,button6,button7,button8,button9,button10,clear;
	View v;
	@Override
	...
	clear=(Button)v.findViewById(R.id.clear);
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
				skillvalues=skillvalues+",SEO";
				skills.setText(skillvalues);
				}
				i=i+1;
				try
				{
				jsonParam10.put(i+"","SEO");
				}
				catch(Exception e)
				{
					e.printStackTrace();
		...
		button2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(skillvalues.equals(""))
				{
					skillvalues="Content writer";
					skills.setText(skillvalues);	
				}
				else
				{
				skillvalues=skillvalues+",Content writer";
				skills.setText(skillvalues);
				}
				i=i+1;
				try
				{
				jsonParam10.put(i+"","Content writer");
				}
				catch(Exception e)
				{
					e.printStackTrace();
...
button3.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
		...
		{
		skillvalues=skillvalues+",ROR";
		skills.setText(skillvalues);
		}
		i=i+1;
		try
		{
		jsonParam10.put(i+"","ROR");
		}
		catch(Exception e)
		{
			e.printStackTrace();
	...
	button4.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(skillvalues.equals(""))
			{
				skillvalues="Web developer";
				skills.setText(skillvalues);	
			}
			else
			{
			skillvalues=skillvalues+",Web developer";
			skills.setText(skillvalues);
			}
			i=i+1;
			try
			{
			jsonParam10.put(i+"","Web developer");
			}
			catch(Exception e)
			{
				e.printStackTrace();
	...
	button5.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			{
			skillvalues=skillvalues+",ANDROID";
			skills.setText(skillvalues);
			}
			i=i+1;
			try
			{
			jsonParam10.put(i+"","ANDROID");
			}
			catch(Exception e)
			{
				e.printStackTrace();
	...
	button6.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(skillvalues.equals(""))
			{
				skillvalues="Tech lead";
				skills.setText(skillvalues);	
			}
			else
			{
			skillvalues=skillvalues+",Tech lead";
			skills.setText(skillvalues);
			}
			i=i+1;
			try
			{
			jsonParam10.put(i+"","Tech lead");
			}
			catch(Exception e)
			{
				e.printStackTrace();
...
button7.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(skillvalues.equals(""))
			{
				skillvalues="Linux administrator";
				skills.setText(skillvalues);	
			}
			else
			{
			skillvalues=skillvalues+",Linux administrator";
			skills.setText(skillvalues);
			}
			i=i+1;
			try
			{
			jsonParam10.put(i+"","Linux administrator");
			}
			catch(Exception e)
			{
				e.printStackTrace();
...
button8.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
		...
		{
		skillvalues=skillvalues+",iOS";
		skills.setText(skillvalues);
		}
		i=i+1;
		try
		{
		jsonParam10.put(i+"","iOS");
		}
		catch(Exception e)
		{
			e.printStackTrace();
...
button9.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
		...
		{
		skillvalues=skillvalues+",HR";
		skills.setText(skillvalues);
		}
		i=i+1;
		try
		{
		jsonParam10.put(i+"","HR");
		}
		catch(Exception e)
		{
			e.printStackTrace();
...
button10.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
		...
		if(skillvalues.equals(""))
		{
			skillvalues="Business development";
			skills.setText(skillvalues);	
		}
		else
		{
		skillvalues=skillvalues+",Business development";
		skills.setText(skillvalues);
		}
		i=i+1;
		try
		{
		jsonParam10.put(i+"","Business development");
		}
		catch(Exception e)
		{
			e.printStackTrace();
