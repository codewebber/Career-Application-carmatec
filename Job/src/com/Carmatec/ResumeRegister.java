...
public class ResumeRegister extends Activity
{
	...
	JSONObject finalvalz= new JSONObject();
	 ...
	 static String json = ""; 
	 EditText experience,releventexperience,currentctc,expectedctc,currentrole,noticeperiod,resonchange;
...
//					ActionBar bar = getActionBar();
		...
		try
		{
			...
			{
				experience.setText(UserProfileEdit.experience);
			}
		...
		public void onClick(View arg0) {
			...
			try 
			{ 
				Register.nameValuePairs.add(new BasicNameValuePair("relevant_exp",releventexperience.getText().toString()));
